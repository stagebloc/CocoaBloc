...
/*!
 It's reccomended to use the createAsset RACSignal. Use this premade exporter session if you really know what you're doing. Calls exporterWithTransform: with the default transform (transformFromRenderSize:)
 */
