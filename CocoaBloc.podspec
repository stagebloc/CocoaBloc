Pod::Spec.new do |s|
  ...
  s.subspec 'Core' do |ss|
    ...
    ss.exclude_files = ["CocoaBloc/Extensions/SBContentStreamObject+ContentType.swift", "CocoaBloc/API Types & Endpoints/API+Content.swift", "CocoaBloc/**/Audio.swift", "CocoaBloc/**/Audio*.swift", "*ReactiveCocoaBloc*"]
  end
